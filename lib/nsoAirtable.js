...
// Returns the existing record (with its id and fields) if found, or null if not.
...
// Updates specific fields on an existing record (used when a concert's date/time changes).
