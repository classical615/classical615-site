...
export function SiteHeader() {
  return (
    <header className="bg-ink border-b-4 border-red">
      <div className="mx-auto max-w-6xl px-6 pt-8 pb-6">
        <div className="flex flex-wrap items-center justify-between gap-6">
          ...
          <nav className="flex items-center gap-6 font-body font-semibold text-sm uppercase tracking-widish text-cream-dim">
            <a href="#events" className="hover:text-red-bright transition-colors">
              This Week
            </a>
            <a href="#calendar" className="hover:text-red-bright transition-colors">
              Calendar
            </a>
            <a
